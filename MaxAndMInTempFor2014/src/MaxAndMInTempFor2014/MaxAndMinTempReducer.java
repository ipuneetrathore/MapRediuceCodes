...
public class MaxAndMinTempReducer extends Reducer<Text, Text, Text, Text> {
    ...
    public void reduce(Text key, Iterable<Text> values, Context output)
		...
		if (key.equals(outputKeyMax))
    	{
			...
			String out_data = "The maximum temperature for the year 2014 in "+temp[0]+" is "+temp[3];
			output.write(outputKeyMax, new Text(out_data));
    	}
		if (key.equals(outputKeyMin))
    	{
			String[] temp = min_temp_val.split("#");
			String out_data = "The minimum temperature for the year 2014 in "+temp[0]+" is "+temp[2];
